...
//			    startConversation(userName);		   		    
			...
			public static void getExcercise() {						
				System.out.println("Moving on. Now how many times a week do you get excercise? Enter a number");			
			...
			public static void food() {						
				System.out.println("Moving on, food and nutrition is also another reason that can effect your health physically and mentally. How do you think your food habit is?");			
				foodHabit = s.next();
				System.out.println("How many meals do you have per day?");
				...
				if(mealsPerDay >=3) {
					...
					//foodBenefits();
					System.out.println("Do you think you eat your greens?");
					vegetables = s.next();
			...
			public static void counselling() {
				System.out.println("Thank you for all of that. I hope I was able to give you valuable advice. Now that I know all that about you, I need to ask you what do you think about counselling?");
				...
				if(seekedCounselling.contains("yes")) {
					...
					if(goodCounseller.contains("yes")) {
						System.out.println("Alright that's perfect then. I guess you won't be needing my help with that then.");
						recommendation();
					}
					else {
						System.out.println("Alright, would you like me to suggest you some new counsellers?");
						...
						if(counsellerYesNo.contains("yes")) {
							...
							System.out.println("Oh alright then. I hope I was helpful.");
							recommendation();
						}
					}
				}
			...
			private static void counsellerList() {
				System.out.println("What kind of counselling would you like between \"individual\" and \"couples\"  counselling?");
				counseller = s.next();
